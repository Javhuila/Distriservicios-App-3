...
class ListViewPdfOrden extends StatefulWidget {
  final String userId;
  final String accessToken;

  const ListViewPdfOrden(
      {super.key, required this.userId, required this.accessToken});

  @override
  State<ListViewPdfOrden> createState() => _ListViewPdfOrdenState();
}

class _ListViewPdfOrdenState extends State<ListViewPdfOrden> {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .where('categoria', isEqualTo: 'Orden_Servicio_Contrato')
            .snapshots(),
