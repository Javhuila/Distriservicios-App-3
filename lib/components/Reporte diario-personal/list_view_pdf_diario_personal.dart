...
class ListViewPdfDiarioPersonal extends StatefulWidget {
  final String userId;
  final String accessToken;

  const ListViewPdfDiarioPersonal(
      {super.key, required this.userId, required this.accessToken});

  @override
  State<ListViewPdfDiarioPersonal> createState() =>
      _ListViewPdfDiarioPersonalState();
}

class _ListViewPdfDiarioPersonalState extends State<ListViewPdfDiarioPersonal> {
  ...
  // Future<List<FileSystemEntity>> _getPdfFiles() async {
