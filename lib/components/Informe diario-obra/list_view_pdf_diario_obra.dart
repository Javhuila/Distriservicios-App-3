...
class ListViewPdfDiarioObra extends StatefulWidget {
  final String userId;
  final String accessToken;

  const ListViewPdfDiarioObra(
      {super.key, required this.userId, required this.accessToken});

  @override
  State<ListViewPdfDiarioObra> createState() => _ListViewPdfDiarioObraState();
}

class _ListViewPdfDiarioObraState extends State<ListViewPdfDiarioObra> {
