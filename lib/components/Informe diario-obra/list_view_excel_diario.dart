...
class ListViewExcelDiario extends StatefulWidget {
  final String userId;
  final String accessToken;

  const ListViewExcelDiario(
      {Key? key, required this.userId, required this.accessToken})
      : super(key: key);

  @override
  State<ListViewExcelDiario> createState() => _ListViewExcelDiarioState();
}

class _ListViewExcelDiarioState extends State<ListViewExcelDiario> {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .where('categoria', isEqualTo: 'Informe_Diario_Obra')
