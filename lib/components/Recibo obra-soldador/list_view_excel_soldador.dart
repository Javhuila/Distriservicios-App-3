...
class ListViewExcelSoldador extends StatefulWidget {
  final String userId;
  final String accessToken;

  const ListViewExcelSoldador(
      {Key? key, required this.userId, required this.accessToken})
      : super(key: key);

  @override
  State<ListViewExcelSoldador> createState() => _ListViewExcelSoldadorState();
}

class _ListViewExcelSoldadorState extends State<ListViewExcelSoldador> {
  ...
  // Función para eliminar el archivo de Firestore
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .where('categoria', isEqualTo: 'Recibo_Obra_Soldador')
