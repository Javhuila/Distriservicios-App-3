...
class ListViewPdfSoldador extends StatefulWidget {
  final String userId;
  final String accessToken;

  const ListViewPdfSoldador(
      {super.key, required this.userId, required this.accessToken});

  @override
  State<ListViewPdfSoldador> createState() => _ListViewPdfSoldadorState();
}

class _ListViewPdfSoldadorState extends State<ListViewPdfSoldador> {
